...
class OSQPProblem {
 public:
  ...
  void set_dx_bounds_set(const std::vector<std::pair<double, double>> &acc_bounds_set);

  void set_pitch_set(const std::vector<double> &refined_pitch);
